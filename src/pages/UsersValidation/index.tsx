        ...
        <Box >
            ...
            <Box className={styles.validationContainer}>
                <Box className={styles.infoContainer} width={"fit-content"} mb={"2vw"}>
                    ...
                    <Input className={styles.cpfInput} data-cy="inputUV-CPF" as={InputMask} mask={"999.999.999-99"} maskChar={null} onChange={handleChange} value={cpf} alt="CPF Input" type="text" padding={0} textAlign={"center"} borderRadius={10} placeholder="CPF" bg={"mono.300"} color={"black"}/>
